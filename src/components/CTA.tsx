...
export function CTA() {
  ...
  return (
    <section id="cta" className="mx-auto w-[min(1240px,92vw)] py-10">
      <Reveal>
        <div className="relative overflow-hidden rounded-[14px] bg-magenta px-[8%] py-[76px] text-center text-white">
          ...
          <h2 className="mx-auto mb-6 max-w-[20ch] text-[clamp(2rem,4.6vw,3.5rem)] text-white">
            {t("titleA")} <span className="text-yellow">{t("titleEm")}</span>
          </h2>
          <a
